  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center space-x-2 px-6 py-3 bg-yellow-500 text-gray-900 font-semibold rounded-none hover:bg-yellow-400 transition-all duration-300 transform hover:scale-105 active:scale-95 btn-glow"
      >
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-56 bg-gray-900 rounded-none py-2 z-20 animate-fade-in border border-white/20 shadow-xl">
            <button
              onClick={downloadJSON}
              className="w-full px-4 py-3 text-left hover:bg-white/10 flex items-center space-x-3 transition-all duration-200"
            >
              ...
              <div>
                ...
                <p className="text-xs text-white/50">Full analysis data</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-white/50">Rankings for Excel</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-white/50">Formatted text report</p>
              </div>
            </button>
          </div>
        </>
